...
- **`descripcion_banner`**: no es una sola línea de specs — el banner tiene sitio para hasta 8 líneas y una sola línea lo deja vacío (caso real, 19-ago-2026: la caminadora Q29-8 salió con solo "CAMINADORA PLEGABLE 2.5 HP · 1 A 6 KM/H · HASTA 120 KG"). Escribí primero un gancho de venta corto (una frase de beneficio o uso, no un dato técnico — ej. "Tu rutina de cardio sin salir de casa"), y a continuación 3 a 5 especificaciones clave separadas por " · " (potencia, velocidad/capacidad, medidas, peso máximo, lo que aplique al producto). Sin inventar nada que la ficha técnica no respalde.
